...
.constant('NAVEGACION', [{
        ...
        estado: 'app.detallecliente',
        file: ['app/modulos/register/js/appR.js',
               'app/modulos/register/js/form.js',
               'app/modulos/register/css/estilos.css'
            ],
        config: {
            url: "detallecliente",
            templateUrl: "app/modulos/register/detalleCliente.html",
            controller: 'detalleClienteController',
            
        }
    },{
        estado: 'app.cliente',
        file: ['app/modulos/register/js/table.js'
               
            ],
        config: {
            url: "cliente",
            templateUrl: "app/modulos/register/cliente.html",
